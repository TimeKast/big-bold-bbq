...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "authors" (
  	...
  	"role" varchar DEFAULT 'Big Bold BBQ',
  	"bio" varchar,
  	"avatar_id" integer,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  ...
  CREATE TABLE "blog_posts_seo_tags" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"tag" varchar
  ...
  CREATE TABLE "_blog_posts_v_version_seo_tags" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"tag" varchar,
  ...
  ALTER TABLE "blog_posts_seo_tags" ADD CONSTRAINT "blog_posts_seo_tags_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."blog_posts"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_blog_posts_v_version_seo_tags" ADD CONSTRAINT "_blog_posts_v_version_seo_tags_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_blog_posts_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "blog_posts_seo_tags_order_idx" ON "blog_posts_seo_tags" USING btree ("_order");
  CREATE INDEX "blog_posts_seo_tags_parent_id_idx" ON "blog_posts_seo_tags" USING btree ("_parent_id");
  ...
  CREATE INDEX "_blog_posts_v_version_seo_tags_order_idx" ON "_blog_posts_v_version_seo_tags" USING btree ("_order");
  CREATE INDEX "_blog_posts_v_version_seo_tags_parent_id_idx" ON "_blog_posts_v_version_seo_tags" USING btree ("_parent_id");
  CREATE INDEX "_blog_posts_v_parent_idx" ON "_blog_posts_v" USING btree ("parent_id");
  CREATE INDEX "_blog_posts_v_version_version_title_idx" ON "_blog_posts_v" USING btree ("version_title");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "blog_posts_seo_tags" CASCADE;
  DROP TABLE "blog_posts" CASCADE;
  DROP TABLE "blog_posts_rels" CASCADE;
  DROP TABLE "_blog_posts_v_version_seo_tags" CASCADE;
